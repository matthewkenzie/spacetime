...
draw_image(img1, ax=ax, beta=0, extent=[0,imgs[0],0,imgs[1]])
...
draw_image(img2, ax=ax, beta=beta, extent=[0,imgs[0],0,imgs[1]], color='b')
...
draw_coord_axes(ax=ax, xrng=(xmin, xmax), yrng=(ymin, ymax))
draw_light_cone(ax=ax)
draw_image(img1, ax=ax, beta=0, extent=[0,imgs[0],T,T+imgs[1]])
# S' frame on S
draw_boost_axes(ax=ax, beta=beta)
draw_image(img2, ax=ax, beta=beta, extent=[0,imgs[0],T,T+imgs[1]], color='b')
#fig.tight_layout()
...
draw_image(img2, ax=ax, beta=0, extent=[0,imgs[0],T,T+imgs[1]], color='b')
draw_light_cone(ax=ax)

# S frame on S'
draw_boost_axes(ax=ax, beta=-beta, color='k', xlab="$x$", ylab="$ct$")
draw_image(img1, ax=ax, beta=-beta, extent=[-imgs[0],0,T,T+imgs[1]], color='k')
#fig.tight_layout()
...
draw_image(img1, ax=ax, beta=0, extent=[0,imgs[0],T,T+imgs[1]])
# S' frame on S
draw_boost_axes(ax=ax, beta=beta, xoff=0.3)
draw_image(img2, ax=ax, beta=beta, extent=[0,imgs[0],T,T+imgs[1]], color='b')
...
# Coord S''
draw_boost_axes(ax=ax, beta=-beta, origin=(2,4), color='g',xlab="$x''$", ylab="$ct''$", xoff=0.3)
draw_sim_lines(ax=ax, grad=-beta, which='y', start=5, lw=1, ls='--', c='g')
fig.savefig('plots/twin_paradox/twpara8.pdf')

draw_image(img3, ax=ax, beta=-beta, extent=[T+T/3,T+T/3+imgs[0],6.66,6.66+imgs[1]], color='g')
...
draw_image(img3, ax=ax, beta=-beta, extent=[5.333,5.333+imgs[0],10.66,10.66+imgs[1]], color='g')
fig.savefig('plots/twin_paradox/twpara10.pdf')
#plt.show()

#######################
## Do the return journey with same twin
########################
...
draw_image(img2, ax=ax, beta=-beta, extent=[T+T/3,T+T/3+imgs[0],6.66,6.66+imgs[1]], color='g')
fig.savefig('plots/twin_paradox/twpara11.pdf')
